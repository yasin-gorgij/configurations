...
(use-package projectile
  ...
  (setq projectile-project-search-path '("~/dev/elixir"))
...
(custom-set-variables
 ...
 '(package-selected-packages
   '(pdf-view-restore exec-path-from-shell yasnippet-snippets which-key vterm visual-fill-column use-package typescript-mode rainbow-delimiters pyvenv python-mode org-bullets no-littering lsp-ui lsp-ivy ivy-rich ivy-prescient helpful general forge flycheck-credo evil-nerd-commenter evil-collection eterm-256color eshell-git-prompt elixir-mode dumb-jump doom-themes doom-modeline dockerfile-mode docker dired-single dired-open dired-hide-dotfiles dap-mode counsel-projectile company-box command-log-mode auto-package-update all-the-icons-dired)))
(custom-set-faces
